...
public class BloomFilter {
     ...
     * <li>1. not null</li>
     * <li>2. {@link BloomFilterData#getBitNum} must be equal to {@code m} </li>
     * <li>3. {@link BloomFilterData#getBitPos} is not null</li>
     * <li>4. {@link BloomFilterData#getBitPos}'s length is equal to {@code k}</li>
     *
     * @param filterData
     * @return
     */
